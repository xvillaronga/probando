	...
	<body>
        ...
        <?php
          ...
          include("../php/conexion.php");
                ...
                $result = $conexion->query("SELECT MONTH(fechaAfiliacion) as meses, COUNT(*) as totalAfiliados, COUNT(IF(sexo='M',sexo,NULL)) as mujeres, COUNT(IF(sexo='H',sexo,NULL)) as hombres FROM afiliacion WHERE YEAR(fechaAfiliacion)= YEAR(DATE_SUB(CURDATE(), INTERVAL 1 YEAR)) group by MONTH(fechaAfiliacion) order by MONTH(fechaAfiliacion)");
   ...
   */          
        ...
        */
            ...
            Highcharts.chart('container', {
                ...
                title: {
                    text: 'Evolución Afiliación Año Anterior'
                },
                subtitle: {
                    text: 'Meses'
                },
