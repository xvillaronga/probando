...
include("conexion.php");
	...
	$result = $conexion->query("Select * from censo where (CategoriaProfesional='Grupo II - Nivel 10' or CategoriaProfesional='Grupo II - Nivel 9' or CategoriaProfesional='Grupo II - Nivel 8' or CategoriaProfesional='Grupo II - Nivel 7') and Puesto like 'Director%' order by Provincia");
...
/************************Segundos más de cuatro años y menos de nivel 6**********************/		
			...
			$result8 = $conexion->query("Select * from censo where (CategoriaProfesional='Grupo II - Nivel 10' or CategoriaProfesional='Grupo II - Nivel 9' or CategoriaProfesional='Grupo II - Nivel 8' or CategoriaProfesional='Grupo II - Nivel 7') and Puesto like 'Segund%' and FechaPuesto < DATE_SUB(CURDATE(), INTERVAL 4 YEAR) order by Provincia");
...
from(Select NumeroOficina, NombreOficina, Provincia, Sociedad from censo where (Sociedad not like 'BANCO%') and (NumeroOficina in (select NumeroOficina from(select NumeroOficina, count(*) as personal from censo group by NumeroOficina having personal<4) as MenosDeCuatro )) and (NumeroOficina not in (select NumeroOficina from censo where (Puesto like 'Segund%'  or Puesto like 'Intervent%' ) group by NumeroOficina)) group by NumeroOficina order by Provincia) Ce inner join oficinas Of on Ce.NumeroOficina = Of.NumeroOficina where Of.TipoCentro='NEGOCIO'  
ORDER BY Ce.Provincia ASC");
	...
	echo "
	 ...
	 /************************FIN Oficinas menos de cuatro personas sin segundo responsable**********************/	
	  ...
	  /************************Gestores de empresas y particulares más de un año y menos de nivel 8*********************/		
			...
			$result11 = $conexion->query("Select * from censo where (CategoriaProfesional='Grupo II - Nivel 10' or CategoriaProfesional='Grupo II - Nivel 9') and (Puesto like 'Gestor Comercial Banca%' or Puesto like 'Gestor Comercial de Banca%' )and FechaPuesto < DATE_SUB(CURDATE(), INTERVAL 1 YEAR) order by Provincia");
...
/************************Gestores de empresas y particulares más de diez años y menos de nivel 6*********************/		
	...
	echo "
	 ...
	 /************************Gestores comerciales más de un año y menos de nivel 8*********************/		
			...
			$result14 = $conexion->query("Select * from censo where (CategoriaProfesional='Grupo II - Nivel 10' or CategoriaProfesional='Grupo II - Nivel 9') and (Puesto='Gestor' or Puesto = 'Gestor Comercial Remoto' )and FechaPuesto < DATE_SUB(CURDATE(), INTERVAL 1 YEAR) order by Provincia");
	...
	echo "
	 ...
	 /************************FIN Gestores comerciales más de un año y menos de nivel 8**********************/
	  ...
	  /************************Gestores comerciales más de cinco años y menos de nivel 7*********************/		
			...
			$result15 = $conexion->query("Select * from censo where (CategoriaProfesional='Grupo II - Nivel 10' or CategoriaProfesional='Grupo II - Nivel 9' or CategoriaProfesional='Grupo II - Nivel 8') and (Puesto='Gestor' or Puesto = 'Gestor Comercial Remoto')and FechaPuesto < DATE_SUB(CURDATE(), INTERVAL 5 YEAR) order by Provincia");
  ...
  /************************Nivel 10 con mas de tres años de antigüedad*********************/		
			...
			$result17 = $conexion->query("select * from censo where (CategoriaProfesional='Grupo II - Nivel 10')and (PrimeraAlta < DATE_SUB(CURDATE(), INTERVAL 3 YEAR)) order by Provincia");
 ...
 /************************Nivel 9 con más de nueve años de antigüedad *********************/		
			...
			$result18 = $conexion->query("	select * from censo where (CategoriaProfesional='Grupo II - Nivel 9')and (PrimeraAlta < DATE_SUB(CURDATE(), INTERVAL 9 YEAR)) order by Provincia");
	...
	echo "
	 ...
	 /************************Nivel 8 con más de quince años de antigüedad *********************/		
			...
			$result19 = $conexion->query("	select * from censo where (CategoriaProfesional='Grupo II - Nivel 8')and (PrimeraAlta < DATE_SUB(CURDATE(), INTERVAL 15 YEAR)) order by Provincia");
	...
	echo "
	 ...
	 /************************Nivel 7 con más de veintiún años de antigüedad *********************/		
			...
			$result20 = $conexion->query("	select * from censo where (CategoriaProfesional='Grupo II - Nivel 7')and (PrimeraAlta < DATE_SUB(CURDATE(), INTERVAL 21 YEAR)) order by Provincia");
	...
	echo "
	 ...
	 /************************Nivel 7 con más de veinticinco años de antigüedad *********************/		
			...
			$result21 = $conexion->query("	select * from censo where (CategoriaProfesional='Grupo II - Nivel 7')and (PrimeraAlta < DATE_SUB(CURDATE(), INTERVAL 25 YEAR)) order by Provincia");
	...
	echo "
	 ...
	 /************************Oficinas con dos o menos empleados **********************/		
			...
			$result22 = $conexion->query("select NumeroOficina, NombreOficina, Provincia, Sociedad from (Select NumeroOficina, NombreOficina, Provincia, Sociedad, count(*) as personal from censo group by NumeroOficina having personal<=2) as MenosDeDos where Sociedad not like 'Banco%' order by Provincia");
