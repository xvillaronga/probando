							...
							<div class='card-body'>
								<div class='row' >";
										echo "
											...
											<div class='col' ><button class='btn btn-success btn-lg btn-block' id='altaVisitaOficina'>Alta Visita</button></div>
											<div class='col' ><button class='btn btn-success btn-lg btn-block' id='consultaVisitaOficina'>Consulta Visita</button></div>";
								echo "</div>"; 
